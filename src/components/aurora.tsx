...
/**
 * Aurora — sfondo WebGL animato (port del componente React Bits).
 * Cortina di luce che ondeggia, ancorata in basso. Usa OGL (già in dipendenza).
 * Rispetta prefers-reduced-motion (rende un singolo frame statico).
 */
...
export function Aurora({
  ...
  useEffect(() => {
    ...
    if (reduce) {
      renderer.render({ scene: mesh }); // singolo frame statico
    } else {
      animateId = requestAnimationFrame(update);
    }
